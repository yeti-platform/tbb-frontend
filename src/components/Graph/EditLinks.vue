<template>
  <div class="new-link mb-2 mr-2 float-left">
    ...
    <a
      ...
      data-toggle="modal"
      data-target="#relationshipModal"
      >Edit {{ selectedLinks.length }} links</a
    >
    <div
      class="modal"
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="saveLinkData" v-bind:class="{ disabled: saving }">
...
export default {
  ...
  methods: {
    fetchLinkData() {
      ...
      axios.get("/relationships/" + linkID + "/").then(response => {
    ...
    saveLinkData() {
      ...
      for (var index = 0; index < this.selectedLinks.length; index++) {
        ...
        axios.put("/relationships/" + linkID + "/", linkData).then(response => {
